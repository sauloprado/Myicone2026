...
export const DEV_CORE_ITEMS: LinkItem[] = [
  { id: 'dev_1', name: 'Python Docs', url: 'https://docs.python.org/3/', category: 'Dev', devSubcategory: 'python-data' },
  { id: 'dev_2', name: 'Pandas', url: 'https://pandas.pydata.org', category: 'Dev', devSubcategory: 'python-data' },
  { id: 'dev_3', name: 'NumPy', url: 'https://numpy.org', category: 'Dev', devSubcategory: 'python-data' },
  { id: 'dev_4', name: 'Matplotlib', url: 'https://matplotlib.org', category: 'Dev', devSubcategory: 'python-data' },
  { id: 'dev_5', name: 'Scikit-learn', url: 'https://scikit-learn.org', category: 'Dev', devSubcategory: 'python-data' },
  { id: 'dev_6', name: 'Jupyter', url: 'https://jupyter.org', category: 'Dev', devSubcategory: 'python-data' },
  { id: 'dev_7', name: 'JavaScript (MDN)', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_8', name: 'TypeScript', url: 'https://www.typescriptlang.org/docs/', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_9', name: 'Node.js', url: 'https://nodejs.org/en/docs', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_10', name: 'React', url: 'https://react.dev', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_11', name: 'Next.js', url: 'https://nextjs.org/docs', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_12', name: 'Vue.js', url: 'https://vuejs.org', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_13', name: 'Angular', url: 'https://angular.dev', category: 'Dev', devSubcategory: 'web-frontend' },
  { id: 'dev_14', name: 'SQLBolt', url: 'https://sqlbolt.com', category: 'Dev', devSubcategory: 'database' },
  { id: 'dev_15', name: 'PostgreSQL', url: 'https://www.postgresql.org/docs/', category: 'Dev', devSubcategory: 'database' },
  { id: 'dev_16', name: 'MySQL', url: 'https://dev.mysql.com/doc/', category: 'Dev', devSubcategory: 'database' },
  { id: 'dev_17', name: 'MongoDB', url: 'https://www.mongodb.com/docs/', category: 'Dev', devSubcategory: 'database' },
  { id: 'dev_18', name: 'Django', url: 'https://docs.djangoproject.com', category: 'Dev', devSubcategory: 'backend' },
  { id: 'dev_19', name: 'FastAPI', url: 'https://fastapi.tiangolo.com', category: 'Dev', devSubcategory: 'backend' },
  { id: 'dev_20', name: 'GitHub', url: 'https://github.com', category: 'Dev', devSubcategory: 'backend' },
];

export const DEV_README_ITEMS: LinkItem[] = [
  { id: 'dev_rd_1', name: 'readme.so', url: 'https://readme.so', category: 'Dev', devSubcategory: 'readme' },
  { id: 'dev_rd_2', name: 'Make a README', url: 'https://www.makeareadme.com', category: 'Dev', devSubcategory: 'readme' },
  { id: 'dev_rd_3', name: 'Shields.io', url: 'https://shields.io', category: 'Dev', devSubcategory: 'readme' },
  { id: 'dev_rd_4', name: 'Carbon', url: 'https://carbon.now.sh', category: 'Dev', devSubcategory: 'readme' },
  { id: 'dev_rd_5', name: 'GitHub Gist', url: 'https://gist.github.com', category: 'Dev', devSubcategory: 'readme' },
  { id: 'dev_rd_6', name: 'Mermaid Live', url: 'https://mermaid.live', category: 'Dev', devSubcategory: 'readme' },
];
